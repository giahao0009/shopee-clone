/**
  index 0: Có 5 sao vàng
  index 1: có 4 sao vàng
  index 2: có 3 sao vàng
  index 3: có 2 sao vàng
  index 4: có 1 sang vàng
      ...
      {Array(5)
        ...
        .map((_, index) => (
          <li className='py-1 pl-2' key={index}>
            <div
              className='mb-2 flex cursor-pointer items-center text-sm'
